  ...
  <div>
    ...
    >
      ...
      <div class="flex justify-between items-center mb-4">
        <p class="text-gray-700 font-medium">Kelola Data Detail Kelompok</p>
        <button
        ...
        <table class="table w-full">
          ...
          <tbody>
            ...
            >
              ...
              <td>
                <RouterLink :to="`/manajemen/kelompok/detail/${kelompok.id}`" class="text-blue-600 hover:underline">
                {{ kelompok.nama }}
                </RouterLink>
              </td>
